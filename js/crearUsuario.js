 document.addEventListener("DOMContentLoaded", function () {
            ...
            const password = document.querySelector('#contrasenaCreate');
            ...
            function validarCampos() {
                ...
                if (!contrasena) {
                    ...
                    document.getElementById('contrasenaErrorCreate').textContent = 'Admite de 8 a 16 dígitos con minúsculas, mayúsculas, caracteres y números';
                    isValid = false;
                } else {
            ...
            function limpiarFormulario() {
                document.getElementById("form-RegisterUser").reset();
