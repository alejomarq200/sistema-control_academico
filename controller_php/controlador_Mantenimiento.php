...
try {
    ...
    // Iniciar script con desactivación de claves foráneas
    $sqlScript = "SET foreign_key_checks = 0;\n\n";

    foreach ($tables as $table) {
        // Eliminar tabla si existe antes de crearla (buena práctica en restauraciones)
    ...
    // Reactivar restricciones de claves foráneas al final
