...
$stmt_madre->execute([$resultadoPlanilla['id']]);
...
$stmt_padre->execute([$resultadoPlanilla['id']]);
...
// Salida
$pdf->Output('I', 'Planilla_Inscripcion_' . $data['cedula_est'] . '_' . $data['nombres_est']. '_' .$data['apellidos_est']. '.pdf');
exit;
