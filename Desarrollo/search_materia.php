...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            <div class="text-center">
                ...
                <div class="mb-4" style="max-width: 600px; margin: 0 auto; background-color: #CBC6E0;  border-radius:15px; padding: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); ">
    ...
    <script src="../js/moduloAsignaturas.js"></script>
</body>
