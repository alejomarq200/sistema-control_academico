...
try {
    ...
    // Consulta con JOIN para traer todos los datos relevantes
    $sql = "SELECT DISTINCT
                e.id, 
                e.cedula_est, 
                e.nombres_est, 
    ...
    foreach ($estudiantes as $estudiante) {
        $html .= '<tr>
                    ...
                    <td class="text-center">
                        <input type="checkbox" class="form-check-input planilla-check2" 
                               name="planillas_seleccionadas_prosecusion[]" 
